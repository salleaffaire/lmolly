#ifndef LMOLLY_BIT_BUFFER_HPP___
#define LMOLLY_BIT_BUFFER_HPP___

#include <cstdint>
#include <iostream>

#define LMOLLY_BIG_ENDIAN    true
#define LMOLLY_LITTLE_ENDIAN false
...
public:
   explicit bitbuffer() : 
      ...
      mContextBytePos(0), mEndianess(LITTLE_ENDIAN)
   {}

   bitbuffer(unsigned char *buffer, unsigned int size_in_bytes, bool endianess) :
